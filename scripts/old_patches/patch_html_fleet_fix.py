...
tab_marker = """            <!-- ÇKS SEKMESİ (BİRLEŞTİRİLMİŞ) -->
            <div id="tab-cks" class="tab-pane">"""

fleet_tab_html = """            <!-- ARAÇ YÖNETİMİ SEKMESİ -->
            ...
            <!-- ÇKS SEKMESİ (BİRLEŞTİRİLMİŞ) -->
            <div id="tab-cks" class="tab-pane">"""

content = content.replace(tab_marker, fleet_tab_html)

# Add CSS for the fleet list hover effect (if not already added)
if ".fleet-item {" not in content:
    style_marker = "</style>"
    fleet_style = """
    .fleet-item {
        padding: 1rem;
...
content = content.replace('v=47', 'v=48')
